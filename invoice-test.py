...
def generate_invoice():
    ...
    company_info = {
        ...
        "nif": request.form.get("company_nif", "")  # We'll label it as "Tax ID" in the PDF
    }
    ...
    client_info = {
        ...
        "nif": request.form.get("client_nif", "")   # We'll label it as "Tax ID" in the PDF
    }
...
def create_pdf(company_info, client_info, invoice_data, items):
    ...
    # Load fonts BEFORE adding the page, because header() uses DejaVu
    ...
    # Use the regular DejaVu font for body text
    ...
    pdf.set_font("DejaVu", "B", 12)
    pdf.cell(40, 5, "Payment Method: ", ln=False)
    pdf.set_font("DejaVu", "", 12)
    ...
    # -- Client Info --
    pdf.set_font("DejaVu", "B", 12)
    pdf.cell(40, 5, "Customer: ", ln=True)
    pdf.set_font("DejaVu", "", 12)
